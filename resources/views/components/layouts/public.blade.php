        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
                    <button class="flex items-center gap-2 p-2 bg-primary hover:bg-emerald-700 hover:text-slate-100 rounded-sm shadow-lg cursor-pointer transition-all duration-200 hover:scale-110">
